<template>
    <vimu-btn class="fill-width mt-6" @click="click">
        <div class="d-flex align-center">
            <svg class="mr-6" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                <path
...
export default class GoogleBtn extends Vue {
    @Emit()
    click() { }
}
</script>
