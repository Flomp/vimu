<template>
  <v-menu offset-y content-class="vimu-menu elevation-0 left-menu-offset" eager>
...
import { } from "../menu_item";
import EditMenu from "./edit_menu.vue";
import FileMenu from "./file_menu.vue";
import ViewMenu from "./view_menu.vue";
