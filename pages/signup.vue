    ...
    <v-row class="fill-height fill-width justify-center align-center ma-0" style="overflow: hidden;">
        ...
        <v-col>
            <div class="login-form">
                <h3 class="login-form-title pb-5">Signup</h3>
                <span class="font-weight-bold">Email</span>
                <vimu-text-field :rules="emailRules"></vimu-text-field>
                <span class="font-weight-bold">Password</span>
                <vimu-text-field type="password"></vimu-text-field>
                <span class="font-weight-bold">Repeat password</span>
                <vimu-text-field type="password"></vimu-text-field>
                <vimu-btn class="fill-width" :primary="true" :large="true">Signup</vimu-btn>
            </div>
        </v-col>
    </v-row>
</template>
